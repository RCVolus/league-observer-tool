...
export const customTheme: CustomThemeConfig = {
    ...
    properties: {
		...
		// =~= Theme Colors  =~=
		// primary | #d8ef5e 
		"--color-primary-50": "249 253 231", // #f9fde7
		"--color-primary-100": "247 252 223", // #f7fcdf
		"--color-primary-200": "245 251 215", // #f5fbd7
		"--color-primary-300": "239 249 191", // #eff9bf
		"--color-primary-400": "228 244 142", // #e4f48e
		"--color-primary-500": "216 239 94", // #d8ef5e
		"--color-primary-600": "194 215 85", // #c2d755
		"--color-primary-700": "162 179 71", // #a2b347
		"--color-primary-800": "130 143 56", // #828f38
		"--color-primary-900": "106 117 46", // #6a752e
		// secondary | #4F46E5 
